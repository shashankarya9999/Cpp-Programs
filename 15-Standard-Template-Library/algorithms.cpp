...
void count_test() 
{
    ...
    std::cout << num << " occurrences found" << " of 1 " << std::endl;
}
...
void all_of_test() 
{
    ...
    if(std::all_of(vec1.begin(), vec1.end(), 
                   [](int x) 
                   { 
                        return x > 10; 
                   }))
...
void string_transform_test() 
{
    ...
    std::transform(str1.begin(), str1.end(), str1.begin(), ::toupper);      // ::fxn means global scope
